...
<div class="widget-header widget-header-large">
	<h3 class="grey lighter pull-left position-relative">
		...
		Data Trayek Bus DAMRI
	</h3>
	<div class="widget-toolbar hidden-480">
	<a href="<?php echo base_url();?>admin/data_trayek/tambah" class="btn btn-small btn-success">&nbsp;<i class="icon-plus-sign bigger-140"></i>&nbsp;Tambah Trayek&nbsp;</a>
...
<table id="sample-table-2" class="table table-striped table-bordered table-hover">
	...
	<tbody>
		...
		?>
			...
			<td><?php echo $row->gid_rute; ?></td>
			<td><?php echo $row->status; ?></td>
			<td width="13%">

			<a href="<?php echo base_url();?>admin/data_trayek/edit/<?php echo $row->id_trayek; ?>" class="btn btn-mini btn-info"><i class="icon-pencil"></i> Ubah </a>

			<a href="" data-toggle="modal" data-target="#hapus<?php echo $row->id_trayek; ?>"class="btn btn-mini btn-danger"><i class="icon-trash"></i>&nbsp;Hapus </a>

			</td>
		</tr>

<div id="hapus<?php echo $row->id_trayek; ?>"  class="modal fade" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    	<div class="modal-dialog">
        	<div class="modal-content">
...
<!-- /page content -->
		        <div class="modal-footer" style="background-image:url(<?php echo base_url();?>style/images/pop-2.jpg)">
		        	...
		        	<a href="<?php echo base_url()?>admin/data_trayek/delete/<?php echo $row->id_trayek; ?>" class="btn btn-danger antosubmit"><i class="fa fa-trash-o"></i>&nbsp;Iya, Hapus</a>
        		</div>
        	</div>
    	</div>
    </div>
