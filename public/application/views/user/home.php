...
<link rel="stylesheet" href="<?php echo base_url(); ?>a/css/lightbox.css"> 
...
<div class="header">
		...
		<div class="w3layouts_header_left">
			<ul>
				<li><a href="<?php echo base_url();?>login" ><i class="fa fa-user" aria-hidden="true" data-toggle="modal" data-target="#myModal2"></i>Login</a></li>
			</ul>
		</div>
		<div class="agileits-social top_content">
			<ul>
				<li><a href="https://www.facebook.com/DishubKabKampar/"><i class="fa fa-facebook"></i></a></li>
...
<script src="<?php echo base_url(); ?>a/js/easyResponsiveTabs.js" type="text/javascript"></script>
	<script type="text/javascript">
		$(document).ready(function () {
	...
	<script src="<?php echo base_url(); ?>a/js/lightbox-plus-jquery.min.js"> </script>
	<script src="<?php echo base_url(); ?>a/js/bars.js"></script>
</body>
</html>
